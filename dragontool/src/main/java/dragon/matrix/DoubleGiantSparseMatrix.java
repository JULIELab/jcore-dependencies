...
public class DoubleGiantSparseMatrix extends AbstractGiantSparseMatrix implements DoubleSparseMatrix{
    ...
    public SparseMatrix createSparseMatrix(){
        ...
        return new DoubleGiantSparseMatrix(indexFile,matrixFile,false,false);
    }
