...
/**
 * <p>A convenient class for basic file utility operations</p>
 * <p></p>
    ...
    public static PrintWriter getPrintWriter(String filename, boolean append, String charSet)
    {
        try
        {
            if(charSet==null)
                charSet=EnvVariable.getCharSet();
            if(charSet!=null)
                return new PrintWriter(new OutputStreamWriter(new FileOutputStream(new File(filename),append),charSet));
            else
