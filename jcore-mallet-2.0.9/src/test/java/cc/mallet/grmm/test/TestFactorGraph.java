...
public class TestFactorGraph {
    ...
    static private TableFactor tbl1;
    static private TableFactor tbl2;
    static private TableFactor tbl3;
    static private LogTableFactor ltbl1;
    static private LogTableFactor ltbl2;
    ...
    public static void setUp() throws Exception {
        vars = new Variable[] { new Variable(2), new Variable(2), new Variable(2), new Variable(2), };
