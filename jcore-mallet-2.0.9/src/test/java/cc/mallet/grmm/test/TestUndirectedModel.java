...
public class TestUndirectedModel {
    ...
    /**
     * Tests that models can be created that have multiple factors over the same variable, and that potentialOfVertex
     * returns the product in that case.
     */
    @Test
    ...
    /**
     * Tests that models can be created that have multiple factors over the same edge, and that potentialOfEdge returns
