 ...
 * <p>
 * <b>Note:</b> In the future this class may go away in favor of some default version of CRFTrainerByValueGradients.
 */
public class CRFTrainerByLabelLikelihood extends TransducerTrainer implements TransducerTrainer.ByOptimization {
     ...
     * scoring criterion given by the {@link FeatureInducer} specified by <code>gainName</code>
     *
     * @param training
     *            The training Instances.
     * @param validation
