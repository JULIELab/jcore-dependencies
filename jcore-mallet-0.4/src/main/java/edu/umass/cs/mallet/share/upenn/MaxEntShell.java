...
public class MaxEntShell {
   ...
   */
  static public Classifier train(String[][]features, String[] labels,
                                 double var, File save)
    throws IOException {
    return train(new
   ...
   * @exception IOException if the trained model cannot be saved
   */
  static public Classifier train(PipeInputIterator data, double var,
                                 File save)
    throws IOException {
   ...
   * @return accuracy on the data
   */
  static public double test(Classifier classifier, PipeInputIterator data) {
