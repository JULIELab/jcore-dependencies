 ...
 * @version $Id: TestPerDocumentF1Evaluator.java,v 1.6 2005/03/01 17:28:58 casutton Exp $
 */
public class TestPerDocumentF1Evaluator extends TestCase {
  ...
  private Extraction createExtractionFrom (String[] predStrings, String[] trueStrings)
  {
    ...
    for (int i = 0; i < pred.size(); i++) {
      Instance aPred = pred.getInstance (i);
      Instance aTarget = targets.getInstance (i);
