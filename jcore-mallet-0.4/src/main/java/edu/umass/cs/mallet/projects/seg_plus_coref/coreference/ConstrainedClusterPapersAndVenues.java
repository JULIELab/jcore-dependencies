...
public class ConstrainedClusterPapersAndVenues
{
	...
	(ConstrainedClusterPapersAndVenues.class, "full-partition", "FILENAME", false, false,
	 "Use full partitioninig", null);

	static CommandOption.Boolean useWeightedAvg = new CommandOption.Boolean
	(ConstrainedClusterPapersAndVenues.class, "use-weighted-avg", "FILENAME", false, false,
	 "Use weighted average", null);

	static CommandOption.String loadMEFile = new CommandOption.String
	(ConstrainedClusterPapersAndVenues.class, "load-me-file", "FILENAME", true, null,
	 "The name of the MaxEnt model file.", null);

	static CommandOption.String outputFile = new CommandOption.String
	(ConstrainedClusterPapersAndVenues.class, "output-file", "FILENAME", true, null,
	...
	(ConstrainedClusterPapersAndVenues.class, "crf-input-file", "FILENAME", true, null,
	...
	(ConstrainedClusterPapersAndVenues.class, "crf-input-file-1", "FILENAME", true, null,
	 "The name of the file to read the trained CRF for testing.", null);

	static CommandOption.String crfInputFile2 = new CommandOption.String
	(ConstrainedClusterPapersAndVenues.class, "crf-input-file-2", "FILENAME", true, null,
	 "The name of the file to read the trained CRF for testing.", null);

	static CommandOption.String crfInputFile3 = new CommandOption.String
	(ConstrainedClusterPapersAndVenues.class, "crf-input-file-3", "FILENAME", true, null,
	 "The name of the file to read the trained CRF for testing.", null);

	static CommandOption.String crfInputFile4 = new CommandOption.String
	(ConstrainedClusterPapersAndVenues.class, "crf-input-file-4", "FILENAME", true, null,
	 "The name of the file to read the trained CRF for testing.", null);

	static CommandOption.Boolean useCRF = new CommandOption.Boolean
	(ConstrainedClusterPapersAndVenues.class, "use-crf", "BOOL", false, false,
	 "Use CRF or not.", null);

	static CommandOption.Boolean useMultipleCRFs = new CommandOption.Boolean
	(ConstrainedClusterPapersAndVenues.class, "use-multiple-crfs", "BOOL", false, false,
	 "Use a separate crf for each data segment or not.", null);

	static CommandOption.Boolean useTreeModel = new CommandOption.Boolean
	(ConstrainedClusterPapersAndVenues.class, "use-tree-model", "BOOL", false, false,
	 "Use and train tree model.", null);

	static CommandOption.Boolean useCorrelational = new CommandOption.Boolean
	(ConstrainedClusterPapersAndVenues.class, "use-correlational", "BOOL", false, false,
	...
	(ConstrainedClusterPapersAndVenues.class, "use-feature-induction", "BOOL", false, false,
	 "Use Feature Induction or Not.", null);

	static CommandOption.Boolean useNBest = new CommandOption.Boolean
	(ConstrainedClusterPapersAndVenues.class, "use-n-best", "BOOL", false, false,
	 "Use NBest or not.", null);

	static CommandOption.Boolean useTrueNumClusters = new CommandOption.Boolean
	(ConstrainedClusterPapersAndVenues.class, "use-true-num-clusters", "BOOL", false, false,
	 "Use NBest or not.", null);

	static CommandOption.Boolean useOptimal = new CommandOption.Boolean
	(ConstrainedClusterPapersAndVenues.class, "use-optimal", "BOOL", false, false,
	 "Use NBest or not.", null);

	static CommandOption.Integer optimalNBest = new CommandOption.Integer
	(ConstrainedClusterPapersAndVenues.class, "optimal-n-best", "INTEGER", true, -1,
	...
	private static Logger logger = MalletLogger.getLogger (ConstrainedClusterPapersAndVenues.class.getName());
	...
	public static void main (String[] args) throws FileNotFoundException
	{
	    ...
	    Collection testS = cl.clusterMentions(itestlist, test_nodes, -1, useCorrelational.value());
			...
			CitationUtils.evaluateClustering (testKey, testS, "ORIGINAL PAPER COREFERENCE RESULTS");
	    if (outputFile.value() != null)
			...
			CitationUtils.evaluateClustering (testKey, constrainedPaperClusters,
																				"CONSTRAINED PAPER COREFERENCE RESULTS");
		}			
