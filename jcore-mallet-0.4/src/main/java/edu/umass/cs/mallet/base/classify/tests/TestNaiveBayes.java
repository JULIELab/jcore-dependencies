...
public class TestNaiveBayes extends TestCase
{
    ...
    public void testIncrementallyTrainedGrowingAlphabets()
    {
       System.out.println("testIncrementallyTrainedGrowingAlphabets");
        String[]    args = new String[] {
               "/usr/gob/users1/hough/melinda-bug2/learn/project",
               "/usr/gob/users1/hough/melinda-bug2/learn/subfdr"
        };
        ...
        NaiveBayes classifier = (NaiveBayes) trainer.incrementalTrain(instList);

        //instList.getDataAlphabet().stopGrowth();

        // incrementally train...
        String[] t2directories = {
                          "/usr/gob/users1/hough/melinda-bug2/update/subfdr"
        };
        ...
        NaiveBayes classifier2 = (NaiveBayes) trainer.incrementalTrain(instList2);
    }
    ...
    public void testIncrementallyTrained()
    {
       System.out.println("testIncrementallyTrained");
        String[]    args = new String[] {
               "src/edu/umass/cs/mallet/base/classify/tests/NaiveBayesData/learn/a",
               "src/edu/umass/cs/mallet/base/classify/tests/NaiveBayesData/learn/b"
        };
