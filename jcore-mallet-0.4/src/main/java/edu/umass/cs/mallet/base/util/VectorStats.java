...
public class VectorStats 
{
	...
	InstanceList.Iterator instanceItr = instances.iterator();
     ...
     * the expected values of those in the <CODE>InstanceList</CODE>. 
	...
	SparseVector mv = new SparseVector (indices, 
					    new double[indices.length],
					    false, true, false);
     ...
     *  
     * @param mean Mean of the given instances.
     * @param unbiased Normalizes variance by N-1 when true, and by N 
     *                 otherwise.
     * @see variance 
     */
