...
public class ClusterPapersGivenVenues
{
	...
	public static void main (String[] args) throws FileNotFoundException
	{
	    ...
	    if (outputFile.value() != null)
			...
			// CLUSTER VENUES
			Collection venueKey = null;
			Collection venueClusters = clusterVenues(venueKey);
			...
			ConstrainedClusterer ccVenue = new ConstrainedClusterer (venueClusters);
			Collection constrainedVenueClusters = ccVenue.constrainByPapers (testS);
			CitationUtils.evaluateClustering (venueKey, constrainedVenueClusters,
																				"CONSTRAINED VENUE COREFERENCE RESULTS");
		}			
	...
	protected static Collection clusterVenues (Collection venueKey) {
	    ...
	    ClusterEvaluate eval1 = new ClusterEvaluate(key, c1);
	    eval1.evaluate();
			System.out.println ("ORIGINAL VENUE COREFERENCE RESULTS\n");
	    System.out.println("Threshold Training Cluster F1: " + eval1.getF1());
	    System.out.println("Threshold Training Cluster Recall: " + eval1.getRecall());
	    System.out.println("Threshold Training Cluster Precision: " + eval1.getPrecision());
	    System.out.println("Number of clusters " + c1.size());
