 ...
 * @version $Id: TObjectFloatHashMapDecorator.java,v 1.3 2004/11/24 20:00:01 casutton Exp $
 * @since trove 0.1.8
 */
public class TObjectFloatHashMapDecorator extends AbstractMap implements Map {
    /** the wrapped primitive map */
    protected final TObjectFloatHashMap _map;
