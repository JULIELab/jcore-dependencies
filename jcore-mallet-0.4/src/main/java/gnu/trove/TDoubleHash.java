 ...
 * @version $Id: TDoubleHash.java,v 1.3 2004/11/24 20:00:00 casutton Exp $
 */
...
abstract public class TDoubleHash extends TPrimitiveHash
    ...
    private TDoubleHashingStrategy hashingStrategy;
    ...
    protected int index(double val) {
        ...
        hash = hashingStrategy.computeHashCode(val) & 0x7fffffff;
        index = hash % length;
