...
public class XmiSplitter {
     ...
     * @param bais The current xmi data as input stream.
     */
    private void storeSelected(ByteArrayInputStream bais) throws XMISplitterException {
                            ...
                            if (isDocElement || (isAnnotation && recursively) || isFeature) {
                                ...
                                if (!(annotationType == null)) {
                                    if (isFSArray(annotationType)) {
                                        ...
                                        log.error("This should not happen. The XMISplitter code seems to have a logical error.");
                                    }
                                } else {
