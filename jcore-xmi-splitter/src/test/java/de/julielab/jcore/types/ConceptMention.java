  ...
  */  
  ...
  public String getSpecificType() {
    if (ConceptMention_Type.featOkTst && ((ConceptMention_Type)jcasType).casFeat_specificType == null)
      jcasType.jcas.throwFeatMissing("specificType", "de.julielab.jcore.types.ConceptMention");
  ...
  public TOP getRef() {
    if (ConceptMention_Type.featOkTst && ((ConceptMention_Type)jcasType).casFeat_ref == null)
      jcasType.jcas.throwFeatMissing("ref", "de.julielab.jcore.types.ConceptMention");
  ...
  public FSArray getResourceEntryList() {
    if (ConceptMention_Type.featOkTst && ((ConceptMention_Type)jcasType).casFeat_resourceEntryList == null)
      jcasType.jcas.throwFeatMissing("resourceEntryList", "de.julielab.jcore.types.ConceptMention");
  ...
  public String getTextualRepresentation() {
    if (ConceptMention_Type.featOkTst && ((ConceptMention_Type)jcasType).casFeat_textualRepresentation == null)
      jcasType.jcas.throwFeatMissing("textualRepresentation", "de.julielab.jcore.types.ConceptMention");
  ...
  public LikelihoodIndicator getLikelihood() {
    if (ConceptMention_Type.featOkTst && ((ConceptMention_Type)jcasType).casFeat_likelihood == null)
      jcasType.jcas.throwFeatMissing("likelihood", "de.julielab.jcore.types.ConceptMention");
    return (LikelihoodIndicator)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((ConceptMention_Type)jcasType).casFeatCode_likelihood)));}
    
  /** setter for likelihood - sets  
   * @generated
   * @param v value to set into the feature 
   */
  public void setLikelihood(LikelihoodIndicator v) {
    if (ConceptMention_Type.featOkTst && ((ConceptMention_Type)jcasType).casFeat_likelihood == null)
      jcasType.jcas.throwFeatMissing("likelihood", "de.julielab.jcore.types.ConceptMention");
    jcasType.ll_cas.ll_setRefValue(addr, ((ConceptMention_Type)jcasType).casFeatCode_likelihood, jcasType.ll_cas.ll_getFSRef(v));}    
  }
