...
public class Header extends DocumentAnnotation {
  ...
  */  
  ...
  /** getter for docType - gets The type of the document (e.g. abstract, fulltext, randomized).
   * @generated
   * @return value of the feature 
   */
  public String getDocType() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_docType == null)
      jcasType.jcas.throwFeatMissing("docType", "de.julielab.jcore.types.Header");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Header_Type)jcasType).casFeatCode_docType);}
    
  /** setter for docType - sets The type of the document (e.g. abstract, fulltext, randomized). 
   * @generated
  ...
  /** getter for source - gets The source of the document (e.g. WWW, database, etc).
   * @generated
   * @return value of the feature 
   */
  public String getSource() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_source == null)
      jcasType.jcas.throwFeatMissing("source", "de.julielab.jcore.types.Header");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Header_Type)jcasType).casFeatCode_source);}
    
  /** setter for source - sets The source of the document (e.g. WWW, database, etc). 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** getter for docId - gets The identifier of the document with respect to its source. E.g.: PMID in PubMed. In combination with the source, this is a unique identifier for a document.
   * @generated
   * @return value of the feature 
   */
  public String getDocId() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_docId == null)
      jcasType.jcas.throwFeatMissing("docId", "de.julielab.jcore.types.Header");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Header_Type)jcasType).casFeatCode_docId);}
    
  /** setter for docId - sets The identifier of the document with respect to its source. E.g.: PMID in PubMed. In combination with the source, this is a unique identifier for a document. 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** getter for copyright - gets Copyright information.
   * @generated
   * @return value of the feature 
   */
  public String getCopyright() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_copyright == null)
      jcasType.jcas.throwFeatMissing("copyright", "de.julielab.jcore.types.Header");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Header_Type)jcasType).casFeatCode_copyright);}
    
  /** setter for copyright - sets Copyright information. 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** getter for truncated - gets Indicates whether the document is truncated.
   * @generated
   * @return value of the feature 
   */
  public boolean getTruncated() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_truncated == null)
      jcasType.jcas.throwFeatMissing("truncated", "de.julielab.jcore.types.Header");
    return jcasType.ll_cas.ll_getBooleanValue(addr, ((Header_Type)jcasType).casFeatCode_truncated);}
    
  /** setter for truncated - sets Indicates whether the document is truncated. 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** getter for authors - gets The authors of the document.
   * @generated
   * @return value of the feature 
   */
  public FSArray getAuthors() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_authors == null)
      jcasType.jcas.throwFeatMissing("authors", "de.julielab.jcore.types.Header");
  ...
  /** setter for authors - sets The authors of the document. 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** indexed getter for authors - gets an indexed value - The authors of the document.
   * @generated
  ...
  /** indexed setter for authors - sets an indexed value - The authors of the document.
   * @generated
  ...
  public String getTitle() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_title == null)
      jcasType.jcas.throwFeatMissing("title", "de.julielab.jcore.types.Header");
  ...
  /** getter for pubTypeList - gets The list of the publication types.
   * @generated
   * @return value of the feature 
   */
  public FSArray getPubTypeList() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_pubTypeList == null)
      jcasType.jcas.throwFeatMissing("pubTypeList", "de.julielab.jcore.types.Header");
  ...
  /** setter for pubTypeList - sets The list of the publication types. 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** indexed getter for pubTypeList - gets an indexed value - The list of the publication types.
   * @generated
   * @param i index in the array to get
   * @return value of the element at index i 
   */
  ...
  /** indexed setter for pubTypeList - sets an indexed value - The list of the publication types.
   * @generated
   * @param i index in the array to set
   * @param v value to set into the array 
   */
  ...
  /** getter for language - gets The language of the document.
   * @generated
   * @return value of the feature 
   */
  public String getLanguage() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_language == null)
      jcasType.jcas.throwFeatMissing("language", "de.julielab.jcore.types.Header");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Header_Type)jcasType).casFeatCode_language);}
    
  /** setter for language - sets The language of the document. 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  public String getDoi() {
    if (Header_Type.featOkTst && ((Header_Type)jcasType).casFeat_doi == null)
      jcasType.jcas.throwFeatMissing("doi", "de.julielab.jcore.types.Header");
