...
public class Header_Type extends DocumentAnnotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jcore.types.Header");
  ...
  public String getDocType(int addr) {
      ...
      jcas.throwFeatMissing("docType", "de.julielab.jcore.types.Header");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "de.julielab.jcore.types.Header");
  ...
  public String getDocId(int addr) {
      ...
      jcas.throwFeatMissing("docId", "de.julielab.jcore.types.Header");
  ...
  public String getCopyright(int addr) {
      ...
      jcas.throwFeatMissing("copyright", "de.julielab.jcore.types.Header");
  ...
  public boolean getTruncated(int addr) {
      ...
      jcas.throwFeatMissing("truncated", "de.julielab.jcore.types.Header");
  ...
  public int getAuthors(int addr) {
      ...
      jcas.throwFeatMissing("authors", "de.julielab.jcore.types.Header");
  ...
  public String getTitle(int addr) {
      ...
      jcas.throwFeatMissing("title", "de.julielab.jcore.types.Header");
  ...
  public int getPubTypeList(int addr) {
      ...
      jcas.throwFeatMissing("pubTypeList", "de.julielab.jcore.types.Header");
  ...
  public String getLanguage(int addr) {
      ...
      jcas.throwFeatMissing("language", "de.julielab.jcore.types.Header");
  ...
  public String getDoi(int addr) {
      ...
      jcas.throwFeatMissing("doi", "de.julielab.jcore.types.Header");
  ...
  public Header_Type(JCas jcas, Type casType) {
    ...
    casFeat_docType = jcas.getRequiredFeatureDE(casType, "docType", "de.julielab.jcore.types.DocType", featOkTst);
    ...
    casFeat_language = jcas.getRequiredFeatureDE(casType, "language", "de.julielab.jcore.types.Language", featOkTst);
