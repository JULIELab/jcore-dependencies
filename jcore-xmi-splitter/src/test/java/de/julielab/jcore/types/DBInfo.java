  ...
  */  
  ...
  public String getName() {
    if (DBInfo_Type.featOkTst && ((DBInfo_Type)jcasType).casFeat_name == null)
      jcasType.jcas.throwFeatMissing("name", "de.julielab.jcore.types.DBInfo");
  ...
  /** getter for acList - gets A list of accession numbers for this DB.
   * @generated
   * @return value of the feature 
   */
  public StringArray getAcList() {
    if (DBInfo_Type.featOkTst && ((DBInfo_Type)jcasType).casFeat_acList == null)
      jcasType.jcas.throwFeatMissing("acList", "de.julielab.jcore.types.DBInfo");
  ...
  /** setter for acList - sets A list of accession numbers for this DB. 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** indexed getter for acList - gets an indexed value - A list of accession numbers for this DB.
   * @generated
  ...
  /** indexed setter for acList - sets an indexed value - A list of accession numbers for this DB.
   * @generated
