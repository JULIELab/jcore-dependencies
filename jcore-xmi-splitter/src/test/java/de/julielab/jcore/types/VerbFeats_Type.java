...
public class VerbFeats_Type extends GrammaticalFeats_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jcore.types.VerbFeats");
  ...
  public String getTense(int addr) {
      ...
      jcas.throwFeatMissing("tense", "de.julielab.jcore.types.VerbFeats");
  ...
  public String getPerson(int addr) {
      ...
      jcas.throwFeatMissing("person", "de.julielab.jcore.types.VerbFeats");
  ...
  public String getNumber(int addr) {
      ...
      jcas.throwFeatMissing("number", "de.julielab.jcore.types.VerbFeats");
  ...
  public String getVoice(int addr) {
      ...
      jcas.throwFeatMissing("voice", "de.julielab.jcore.types.VerbFeats");
  ...
  public String getAspect(int addr) {
      ...
      jcas.throwFeatMissing("aspect", "de.julielab.jcore.types.VerbFeats");
  ...
  public VerbFeats_Type(JCas jcas, Type casType) {
    ...
    casFeat_tense = jcas.getRequiredFeatureDE(casType, "tense", "de.julielab.jcore.types.Tense", featOkTst);
    ...
    casFeat_voice = jcas.getRequiredFeatureDE(casType, "voice", "de.julielab.jcore.types.Voice", featOkTst);
    casFeatCode_voice  = (null == casFeat_voice) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_voice).getCode();

 
    casFeat_aspect = jcas.getRequiredFeatureDE(casType, "aspect", "de.julielab.jcore.types.Aspect", featOkTst);
