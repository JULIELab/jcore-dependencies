  ...
  */  
  ...
  public String getExpan() {
    if (Abbreviation_Type.featOkTst && ((Abbreviation_Type)jcasType).casFeat_expan == null)
      jcasType.jcas.throwFeatMissing("expan", "de.julielab.jcore.types.Abbreviation");
   ...
   * @return value of the feature 
   */
  public AbbreviationLongform getTextReference() {
    if (Abbreviation_Type.featOkTst && ((Abbreviation_Type)jcasType).casFeat_textReference == null)
      jcasType.jcas.throwFeatMissing("textReference", "de.julielab.jcore.types.Abbreviation");
    return (AbbreviationLongform)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Abbreviation_Type)jcasType).casFeatCode_textReference)));}
    
  /** setter for textReference - sets Reference to the text span that contains the  full form of the abbreviation/acronym 
   * @generated
   * @param v value to set into the feature 
   */
  public void setTextReference(AbbreviationLongform v) {
    if (Abbreviation_Type.featOkTst && ((Abbreviation_Type)jcasType).casFeat_textReference == null)
      jcasType.jcas.throwFeatMissing("textReference", "de.julielab.jcore.types.Abbreviation");
  ...
  public boolean getDefinedHere() {
    if (Abbreviation_Type.featOkTst && ((Abbreviation_Type)jcasType).casFeat_definedHere == null)
      jcasType.jcas.throwFeatMissing("definedHere", "de.julielab.jcore.types.Abbreviation");
