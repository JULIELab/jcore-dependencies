...
public class StemmedForm_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jcore.types.StemmedForm");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "de.julielab.jcore.types.StemmedForm");
