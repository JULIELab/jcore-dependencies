...
public class OntRelationMention_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jcore.types.OntRelationMention");
  ...
  public int getDomain(int addr) {
      ...
      jcas.throwFeatMissing("domain", "de.julielab.jcore.types.OntRelationMention");
  ...
  public int getRange(int addr) {
      ...
      jcas.throwFeatMissing("range", "de.julielab.jcore.types.OntRelationMention");
  ...
  public int getDomainList(int addr) {
      ...
      jcas.throwFeatMissing("domainList", "de.julielab.jcore.types.OntRelationMention");
  ...
  public int getRangeList(int addr) {
      ...
      jcas.throwFeatMissing("rangeList", "de.julielab.jcore.types.OntRelationMention");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "de.julielab.jcore.types.OntRelationMention");
  ...
  public String getOntRelationId(int addr) {
      ...
      jcas.throwFeatMissing("ontRelationId", "de.julielab.jcore.types.OntRelationMention");
  ...
  public String getSourceOntology(int addr) {
      ...
      jcas.throwFeatMissing("sourceOntology", "de.julielab.jcore.types.OntRelationMention");
  ...
  public String getTextualRepresentation(int addr) {
      ...
      jcas.throwFeatMissing("textualRepresentation", "de.julielab.jcore.types.OntRelationMention");
  ...
  public OntRelationMention_Type(JCas jcas, Type casType) {
    ...
    casFeat_domain = jcas.getRequiredFeatureDE(casType, "domain", "de.julielab.jcore.types.Annotation", featOkTst);
    casFeatCode_domain  = (null == casFeat_domain) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_domain).getCode();

 
    casFeat_range = jcas.getRequiredFeatureDE(casType, "range", "de.julielab.jcore.types.Annotation", featOkTst);
