...
public class Segment_Type extends Zone_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jcore.types.Segment");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "de.julielab.jcore.types.Segment");
