...
public class Lemma_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jcore.types.Lemma");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "de.julielab.jcore.types.Lemma");
