...
public class Annotation_Type extends org.apache.uima.jcas.tcas.Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.julielab.jcore.types.Annotation");
  ...
  public String getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "de.julielab.jcore.types.Annotation");
  ...
  public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "de.julielab.jcore.types.Annotation");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "de.julielab.jcore.types.Annotation");
