 ...
 * @version $Id: TShortShortHashMapDecorator.java,v 1.1 2004/11/09 15:48:50 ericdf Exp $
 * @since trove 0.1.8
 */
public class TShortShortHashMapDecorator extends AbstractMap implements Map, Cloneable {
