...
import de.julielab.gnu.trove.TObjectByteHashMap;
import de.julielab.gnu.trove.TObjectByteIterator;
 ...
 * @version $Id: TObjectByteHashMapDecorator.java,v 1.1 2004/11/09 15:48:50 ericdf Exp $
 * @since trove 0.1.8
 */
public class TObjectByteHashMapDecorator extends AbstractMap implements Map, Cloneable {
    /** the wrapped primitive map */
    protected TObjectByteHashMap _map;

    /**
     * Creates a wrapper that decorates the specified primitive map.
     */
    public TObjectByteHashMapDecorator(TObjectByteHashMap map) {
	super();
	this._map = map;
    }
	...
	if (_map.equals(other)) {
		...
		for (int i = that.size(); i-- > 0;) {
		    ...
		    if (key instanceof Object && val instanceof Byte) {
    ...
    public Set entrySet() {
		...
		public Iterator iterator() {
		    return new Iterator() {
			    private final TObjectByteIterator it = _map.iterator();
