...
import de.julielab.gnu.trove.TByteObjectHashMap;
import de.julielab.gnu.trove.TByteObjectIterator;
 ...
 * @version $Id: TByteObjectHashMapDecorator.java,v 1.1 2004/11/09 15:48:50 ericdf Exp $
 * @since trove 0.1.8
 */
public class TByteObjectHashMapDecorator extends AbstractMap implements Map, Cloneable {
    /** the wrapped primitive map */
    protected TByteObjectHashMap _map;

    /**
     * Creates a wrapper that decorates the specified primitive map.
     */
    public TByteObjectHashMapDecorator(TByteObjectHashMap map) {
	super();
	this._map = map;
    }
	...
	if (_map.equals(other)) {
		...
		for (int i = that.size(); i-- > 0;) {
		    ...
		    if (key instanceof Byte && val instanceof Object) {
    ...
    public Set entrySet() {
		...
		public Iterator iterator() {
		    return new Iterator() {
			    private final TByteObjectIterator it = _map.iterator();
