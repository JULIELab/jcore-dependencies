...
import de.julielab.gnu.trove.TObjectShortIterator;
 ...
 * @version $Id: TObjectShortHashMapDecorator.java,v 1.1 2004/11/09 15:48:50 ericdf Exp $
 * @since trove 0.1.8
 */
public class TObjectShortHashMapDecorator extends AbstractMap implements Map, Cloneable {
    ...
    public Set entrySet() {
		...
		public Iterator iterator() {
		    return new Iterator() {
			    private final TObjectShortIterator it = _map.iterator();
