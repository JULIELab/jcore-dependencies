 ...
 * @version $Id: TByteFloatHashMapDecorator.java,v 1.1 2004/11/09 15:48:50 ericdf Exp $
 * @since trove 0.1.8
 */
public class TByteFloatHashMapDecorator extends AbstractMap implements Map, Cloneable {
