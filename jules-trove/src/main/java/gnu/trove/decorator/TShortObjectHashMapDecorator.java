...
import de.julielab.gnu.trove.TShortObjectHashMap;
import de.julielab.gnu.trove.TShortObjectIterator;
 ...
 * @version $Id: TShortObjectHashMapDecorator.java,v 1.1 2004/11/09 15:48:50 ericdf Exp $
 * @since trove 0.1.8
 */
public class TShortObjectHashMapDecorator extends AbstractMap implements Map, Cloneable {
    /** the wrapped primitive map */
    protected TShortObjectHashMap _map;

    /**
     * Creates a wrapper that decorates the specified primitive map.
     */
    public TShortObjectHashMapDecorator(TShortObjectHashMap map) {
	super();
	this._map = map;
    }
	...
	if (_map.equals(other)) {
		...
		for (int i = that.size(); i-- > 0;) {
		    ...
		    if (key instanceof Short && val instanceof Object) {
    ...
    public Set entrySet() {
		...
		public Iterator iterator() {
		    return new Iterator() {
			    private final TShortObjectIterator it = _map.iterator();
