 ...
 * @version $Id: TObjectByteProcedure.java,v 1.1 2004/11/09 15:48:47 ericdf Exp $
 */

public interface TObjectByteProcedure {
     ...
     * @param b an <code>byte</code> value
     * @return true if additional invocations of the procedure are
     * allowed.
     */
    public boolean execute(Object a, byte b);
