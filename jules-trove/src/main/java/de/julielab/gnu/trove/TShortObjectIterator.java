 ...
 * @version $Id: TShortObjectIterator.java,v 1.2 2005/03/26 17:30:24 ericdf Exp $
 */

public class TShortObjectIterator extends TPrimitiveIterator {
     ...
     */
    public TShortObjectIterator(TShortObjectHashMap map) {
	super(map);
	this._map = map;
    }
