 ...
 * @version $Id: TByteObjectHashMap.java,v 1.2 2005/03/26 17:52:55 ericdf Exp $
 */
public class TByteObjectHashMap extends TByteHash implements Serializable {
     ...
     */
    public Object clone() {
      TByteObjectHashMap m = (TByteObjectHashMap)super.clone();
     ...
     */
    public boolean forEachEntry(TByteObjectProcedure procedure) {
        byte[] states = _states;
        byte[] keys = _set;
        Object[] values = _values;
        for (int i = keys.length; i-- > 0;) {
     ...
     */
    public boolean retainEntries(TByteObjectProcedure procedure) {
