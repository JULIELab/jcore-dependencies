 ...
 * @version $Id: TShortObjectHashMap.java,v 1.2 2005/03/26 17:52:56 ericdf Exp $
 */
public class TShortObjectHashMap extends TShortHash implements Serializable {
     ...
     */
    public Object clone() {
      TShortObjectHashMap m = (TShortObjectHashMap)super.clone();
     ...
     */
    public boolean forEachEntry(TShortObjectProcedure procedure) {
        byte[] states = _states;
        short[] keys = _set;
        Object[] values = _values;
        for (int i = keys.length; i-- > 0;) {
     ...
     */
    public boolean retainEntries(TShortObjectProcedure procedure) {
